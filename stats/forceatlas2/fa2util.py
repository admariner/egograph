...
def apply_attraction(nodes, edges, distributedAttraction, coefficient, edgeWeightInfluence, linLogMode, anticollision=False):
    if linLogMode:
        ...
        if edgeWeightInfluence == 0:
            ...
            for edge in edges:
                linAttraction(nodes[edge.node1], nodes[edge.node2], pow(edge.weight, edgeWeightInfluence), distributedAttraction, coefficient, anticollision=anticollision)
