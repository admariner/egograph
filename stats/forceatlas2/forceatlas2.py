...
class ForceAtlas2:
    def __init__(self,
                 ...
                 # Log
                 verbose=True):
        assert multiThreaded == False, "You selected a feature that has not been implemented yet..."
    ...
    def forceatlas2(self,
        ...
        for _i in niters:
            ...
            fa2util.apply_attraction(nodes, edges, self.outboundAttractionDistribution, outboundAttCompensation,
                                     self.edgeWeightInfluence, self.linLogMode, anticollision=self.adjustSizes)
    ...
    def forceatlas2_networkx_layout(self, G, pos=None, sizes=None, iterations=100, weight_attr=None):
        import networkx
        try:
            import cynetworkx
        except ImportError:
